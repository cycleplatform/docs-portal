...
This section is meant to cover the portal level implementation for configuring the v1 load balancer. If theres a field or value that isn't quite explained thoroughly enough here, you may want to take a look at the [stack reference](/reference/stacks/) which has a bit more structured information.
:::
