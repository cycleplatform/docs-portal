  ...
  return (
    ...
    >
      ...
      <TabItem value="docker-file">
        <p>
          Generally a <code>docker-file</code> image source would need to have information about a repo or a url endpoint where a tar.gz package was being served. However, when importing a stack file on Cycle, generally a user will do so
          through a git repo. For <code>docker-file</code> image source's, this repo information is used when both the repo and targz_url are not used in the details and is why neither is marked as required.
        </p>
