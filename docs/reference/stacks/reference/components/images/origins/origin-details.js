...
export const Details = {
  dockerhub: [
    [
      ...
      "String",
      "✅",
      "The name and tag of the image as listed on Docker Hub, separated by a colon.",
    ],
    [
      "username",
      "String",
      "❌",
      "A private DockerHub repo's username, for auth.",
    ],
  ...
  dockerregistry: [
    ...
    [
      ...
      "String",
      "❌",
      "A private Docker registries username, for auth.",
    ],
    ...
    [
      ...
      "String",
      "❌",
      "A private Docker registry password, for auth.",
    ],
    [
      "target",
      "String",
  ...
  dockerfile: {
    shared: [
      [
        ...
        "Object",
        "❌",
        "An object holding information about the remote repository for the image.",
      ],
      [
        `targz_url`,
        "String",
        "❌",
        "A url that serves a tar.gz package of image files, for this image.",
      ],
      [
        `context_dir`,
        "String",
        "❌",
        "The full path to the directory that should be treated as the root context when copying files from source to the image.",
      ],
      [
        `build_file`,
        "String",
        "❌",
        "An object holding remote repository information. If an image uses repo, it cannot use targz_url.",
      ],
      [
        `credentials`,
        "Array",
        "❌",
        "An array of credentials objects to be used when parent images referenced in Dockerfiles or submodules require authentication.",
      ],
    ],
    repo: [
      ...
      [
        ...
        "Object",
        "❌",
        "An object holding authentication type and credentials for the remote git repository.",
      ],
      [
        "branch",
        "String",
        "❌",
        "A branch to use when pulling files from the repo.",
      ],
      [
        "ref",
        "Object",
        "❌",
        "An object holding a reference type of hash or tag and its corresponding value.",
      ],
      [
        "credentials",
        "String",
    ...
    ref: {
      hash: [
        [
          ...
          "String",
          "✅",
          "The protocol to be used for authentication - either http or ssh.",
        ],
        [
          "credentials",
          "Object",
          "✅",
          "The corresponding credentials to use for the given auth type.",
        ],
      ],
      tag: [
        [
      ...
      credentials: {
        http: [
          [
            ...
            "String",
            "✅",
            "The username for the remote repository http authentication.",
          ],
          [
            "password",
            "String",
            "✅",
            "The password for the remote repository http authentication.",
          ],
        ],
        ssh: [
          [
            ...
            "String",
            "✅",
            "The username for the remote repository ssh authentication.",
          ],
          [
            "passphrase",
            "String",
            "❌",
            "The passphrase for the SSH key provided, if one was set during key create.",
          ],
          [
            "private_key",
            "String",
            "✅",
            "A private ssh key that works with the public key on the remote repository.",
          ],
        ],
      },
    },
