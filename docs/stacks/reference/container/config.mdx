...
import { RuntimeTable, RuntimeExample} from "../components/config/runtime/runtime";
...
|ram       | Object                                |✅        | ❌       | An object holding the RAM container instance configuration settings, including swapiness and kernel fields. |
...
|kernel    | String                                |❌        | ✅        | The amount of RAM to allocate to the kernel log for each instance. |
|kernel_tcp| String                                |❌        | ✅        | The amount of write space to be kept during a lost connection. |
