...
import { RuntimeTable, RuntimeCommandTable, RuntimeExample, SeccompRulesTable, SeccompRulesCapabilitiesTable, SeccompRulesSyscallTable, SeccompArgsTable, SeccompObjectTable } from "../components/config/runtime/runtime";
...
| Field   | Type   | Required | Description                                                                                                                                                                                                              |
| ------- | ------ | :------: | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| stagger | number |    ✅    | A number that Cycle will use to generate a randomized delay in the event. Ex: using the number 10 - Cycle will wait a random number between 0 and 10 seconds when restarting instances of this container during reimage. |
...
| backups      | Object |    ❌    | For stateful instances [backups](/docs/containers/backups) can be defined. |
...
For stateful instances [backups](/docs/containers/backups) can be defined.
