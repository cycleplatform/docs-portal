...
2. Infrastructure access - whether you have an on-prem rack you want to connect or you'd like to get started with one of our [supported IaaS providers](/reference/infrastructure/providers), you'll need to be able to deploy servers to use the platform. 
