In order to add a provider to Cycle, certain resources are needed from each provider. On [this page](/reference/hubs/integrations/providers) the resources needed are listed.
